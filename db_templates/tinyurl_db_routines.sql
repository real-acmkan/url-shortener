...
--
-- Host: localhost    Database: tinyurl_db
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'tinyurl_db'
--
...
BEGIN
    -- Check if the user owns the short URL
...
BEGIN
    ...
    DELETE FROM ValidatedEmails WHERE user_id = user_id; -- Reset verification if email changes
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2025-02-11 12:51:32
